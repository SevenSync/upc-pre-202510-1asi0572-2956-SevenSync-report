...
_Lean UX Canvas del proyecto Macetech_
...
* **Entrevista N°1**
  ...
  * **Final de Entrevista:** 8:35
    ...
    _Nota_. En la imagen se puede visualizar a la entrevistada, Rosalinda Quispe, en el lado derecho, mientras que el entrevistador y miembro de SevenSync, Ruben Mallma, se encuentra en el lado izquierdo. <br><br>
...
- **Entrevista N°4**
  ...
  - **Fin de entrevista:** 31:27
    ...
    _Nota_. En la imagen se puede visualizar al entrevistado, Yasser Rentería, en el lado derecho, mientras que el entrevistador y miembro de SevenSync, Lucio Yen, se encuentra en el lado izquierdo.<br><br>
...
- **Entrevista N°5**
  ...
  - **Final de Entrevista:** 42:23
    ...
    _Nota_. En la imagen se puede visualizar al entrevistado, Javier Hernández, en el centro de la pantalla, mientras que el entrevistador y miembro de SevenSync, Juan Pescorán, se encuentra en el lado inferior derecho. <br><br>
...
| Sensores o medidores de humedad |	1	|No	|Sí	|No|	33.3 %	|Incluir calibración de sensores y alertas de umbral específicas, aprovechando la adopción parcial de medidores de húmedad en los usuarios.|
| Dependencia exclusiva de riego manual |	1	|Sí|No	|No	|33.3 %	|Ofrecer opción de riego manual para usuarios que valoran la interacción directa y hobby de la jardinería, sin forzar automatización completa y total en el riego. |
| Uso de remedios naturales para plantas	|1|	Sí|	No|	No|	33.3 %|	Brindar recomendaciones personalizadas de jardinería que contemplen prácticas empíricas (ajo, cáscaras) y posibilidad de registrar esas notas por cada planta en la que se utiliza.|
|Gestión de 50 a más macetas	|2|	No |Sí |	Sí |66.7 %	| Desarrollar menús de agrupación y filtrado para gestionar grandes volúmenes (más de 50 macetas), optimizando la visualización en listas y dashboards.|
| Uso de smartphone y aplicación móvil	|3	|Sí	|Sí	|Sí	|100 %	| Priorizar una aplicación móvil intuitiva y ligera, con notificaciones push de estado, programación de sistema de riego, y alertas en tiempo real junto a recomendaciones específicas. |
|Uso de computadora o laptop y aplicación web|	1|	No|	No |Sí	|33.3 %|	Ofrecer versión web con interfaz detallada para usuarios que deseen mayor profundidad con respecto a los dashboards con estadísticas, pero no obligatoria para todos.|
|Preferencia por dashboard de supervisión	| 3 |Sí |Sí |	Sí	|100 %	|Integrar dashboards claros y visuales, con métricas de humedad, pH y nutrientes, además de historial de riego y abonado realizados por el usuario por un plazo de más de una semana.|
| Sistema operativo Android para móvil	| 3	| Sí (Xiaomi Redmi) | Sí (Samsung Galaxy A35)| Sí (Xiaomi Redmi)| 100 %	| Garantizar compatibilidad con Android. Considerar desarrollo futuro para iOS, aunque en esta muestra no hay usuarios de iPhone. No es una prioridad.
| Sistema operativo Windows para web | 2 | No (No usa web) | Sí (Windows en laptop HP, aunque no la usa para jardinería) | Sí (Windows en laptop HP y computadora Dell) | 66.7% | Optimizar la versión web para Windows (principal plataforma de acceso) y verificar compatibilidad básica con navegadores en otros sistemas operativos, aunque no es prioritario. |
| Browser principal Chrome | 3	| Sí | Sí | Sí | 100 %	| Asegurar que la web y la app estén completamente optimizadas para Chrome (versión móvil y escritorio). Considerar pruebas en otros navegadores populares como Firefox o Edge a futuro.|
| Compra en viveros |	2	| Sí | Sí | No | 66.7% | Los usuarios compran tanto en viveros como en tiendas de tipo homecenter. En las tiendas compran herramientas de calidad mientras que en los viveros se centran en la compra de plantas o abonos personalizados.|
...
- Sistemas de riego automatizado (66.7 %) y sensores de humedad (66.7 %) son usados por la mayoría. <br><br>
- Aplicaciones móviles (66.7 %) y web (66.7 %) también presentan alta adopción. <br><br> 

- **Implicaciones:** El perfil del especialista ya está parcialmente familiarizado con soluciones tecnológicas, por lo que el diseño no necesita partir desde cero en términos de alfabetización digital. Se debe priorizar la interoperabilidad entre tecnologías existentes (por ejemplo, sensores previos) y brindar funcionalidad multiplataforma (web + app móvil).

**2. Necesidad de un sistema híbrido y personalizable**

- 33.3 % aún depende exclusivamente del riego manual, y 100 % abona sus plantas, ya sea empíricamente o programando fechas. <br><br>
- Un entrevistado utiliza remedios naturales, reflejando diversidad en prácticas.<br><br>

- **Implicaciones:** El producto debe ser modular y configurable. Se recomienda incorporar modos híbridos (manual + automático) para adaptarse al nivel técnico del usuario. También es necesario incluir opciones de personalización para prácticas culturales o empíricas (como uso de remedios naturales, fertilización tradicional).

**3. Enfoque en la gestión masiva de plantas**

- 66.7 % administra más de 50 macetas o plantas. <br><br>
- 100 % prefiere dashboards para visualización y supervisión de métricas.<br><br>

- **Implicaciones:** Se requiere una interfaz escalable, con capacidades de agrupación, filtrado y monitoreo simultáneo de múltiples unidades vegetales. Los dashboards deben ofrecer datos relevantes, como humedad, estado nutricional, historial de riego y alertas, con visualizaciones claras y exportables.

**4. Integración total entre tareas clave del cuidado**

- El 100 % programa la fertilización, lo cual sugiere una mentalidad planificada y orientada al rendimiento.<br><br>

- Sensores y automatización de riego son comunes, y el uso de apps móviles refuerza la tendencia hacia el control digital. <br><br>

- **Implicaciones:** Se deben implementar módulos de calendario, recordatorios inteligentes y sugerencias automatizadas en base a datos históricos. Incorporar funciones de aprendizaje automático podría mejorar las predicciones sobre necesidades hídricas o nutricionales por planta.

**5. Valoración de ahorro de recursos y sostenibilidad**

- 100 % manifiesta preocupación por optimizar el uso de agua y fertilizantes para reducir costos operativos y desperdicio. <br><br>

- Buscan métricas que cuantifiquen el ahorro logrado y comparativas entre prácticas tradicionales versus automatizadas. <br><br>

- **Implicaciones:** Incorporar indicadores de sostenibilidad que muestren litros de agua ahorrados y dosis de nutrientes optimizadas por planta, además de sugerencias de prácticas ecológicas (p. ej., reciclaje de agua de riego y abonos orgánicos), reforzando la propuesta de valor ambiental.

**6. Valoración de marcas y calidad percibida**

- 100 % selecciona marcas reconocidas (Ferticorp, Just Home Collection, 4Estaciones, Ergo, Orange) basándose en experiencias previas y reputación de eficacia en jardinería.<br><br>

- Prefieren productos de esas firmas aun cuando cuesten un poco más, siempre que garanticen durabilidad y rendimiento. No compran estrictamente por precio sino por confianza en la marca.<br><br>

**7. Valoración de puntos de venta y accesibilidad**

- 100 % visita tiendas especializadas que conocen (Promart Homecenter, Sodimac Homecenter, viveros locales, Maestro) por cercanía y surtido adecuado para jardinería profesional o hobby.<br><br>

- Buscan disponibilidad inmediata de insumos y, en algunos casos, comparación de precios entre puntos de venta cercanos antes de decidir dónde comprar.<br><br>

**8. Valoración de dispositivos y sistemas operativos**

- 100 % utiliza Android en sus smartphones (Xiaomi Redmi, Samsung Galaxy). Ningún entrevistado emplea iOS para el monitoreo diario.<br><br>

- 100 % utiliza Windows en sus computadoras o laptops (HP, Dell). No hay uso de Linux o MacOS en esta muestra, aunque algunos poseen laptops que no usan para jardinería.<br><br>

- **Implicaciones:** Asegurar que la aplicación móvil sea completamente compatible con Android (incluyendo notificaciones push y optimización para versiones recientes de MIUI y One UI). Desarrollar la versión web pensando en navegadores de Windows (Chrome principalmente), garantizando que funciones críticas no dependan de sistemas operativos alternativos.

**9. Sensores de pH o nutrientes (demanda latente)**

- Ninguno de los entrevistados usa actualmente sensores de pH, nutrientes o salinidad, pero todos requieren mediciones de pH y nutrientes.<br><br>

- **Implicaciones:** Desarrollar y validar módulo de sensor integrado de pH y nutrientes, presentándolo como característica diferenciadora para cubrir una necesidad no satisfecha.

**10. Nivel de confianza en apps móviles / apps web**

- Todos los entrevistados cuentan con un nivel de confianza y experiencia desde moderado a más en el uso de aplicación móviles y web.<br><br>

- **Implicaciones:** Implementar onboarding guiado y tutoriales interactivos paso a paso, ajustando complejidad según nivel de usuario. Añadir la opción de "omitir" para usuarios que ya entienden la interfaz y como funcionan este tipo de aplicaciones.

**11. Disposición a pagar por las membresías**

- Todos los entrevistados muestran sensibilidad al costo-beneficio. Dispuestos a invertir en calidad.
...
| Característica| Presencia en muestra (n = 3) | Betty (n = 1)	|Javier (n = 1)	|Yasser (n = 1)|	Frecuencia (%)	|Implicación para el diseño|
|------|-------|--------|--------|---------|---------|----------|
|Conexión emocional con las plantas que cuida |	2	|Sí	|No|	Sí|	66.7 %|	Incluir elementos simples de retroalimentación que refuercen la satisfacción emocional de los usuarios (mensajes positivos y agradables, fotos de progreso).|
|Enfoque observacional y empírico	|3	|Sí	|Sí	|Sí	|100 %	|Destacar datos cuantitativos (humedad, pH) junto a consejos simples para complementar la observación manual de la información brindada.|
|Balance entre control manual y automatización|	3	|Sí|	Sí|	Sí|	100 %	|Ofrecer modo híbrido con una interfaz para riego manual con opción de cambiar a automático, y viceversa, sin complicaciones directas hacia el usuario.|
|Actitud meticulosa y orientada al detalle|	3|	Sí|	Sí|Sí	|100 %|	Mostrar métricas granulares y gráficas históricas, permitiendo análisis detallado de cada planta y acción tomada por los usuarios según recomendaciones y alertas.|
|Valoración estético-funcional del producto|	3 |	Sí|	Sí	|Sí|	100 %|	Diseñar la maceta con acabados minimalistas y ocultar cables. La UI debe ser limpia, con colores neutros y tipografía legible en cada una de las páginas y actividades.|
|Necesidad de supervisión remota en tiempo real|	2	|No|	Sí|	Sí	|66.7 %	| Implementar notificaciones push y acceso web/móvil a dashboard en tiempo real, con alertas configurables según prioridad que indiqué el usuario en su cuenta. |
| Valoración de ahorro de recursos (agua y tiempo)| 	3	|Sí	|Sí	|Sí|	100 %	|Incluir métricas comparativas que muestren ahorro de agua y horas invertidas, para reforzar el beneficio económico y de eficiencia del sistema y presentarlo al usuario para que sienta mayor seguridad y confianza. |
| Preferencia por personalización de alertas y notificaciones	| 3	| Sí |	Sí |	Sí	 |100 %	| Permitir configurar tipos de notificaciones (visual, sonora, por voz) y franjas horarias para recibir alertas, adaptándose a las rutinas y niveles de tolerancia de cada usuario. |
|Interés en integración con domótica |	1|	No|	No	|Sí|	33.3 %	|Preparar la arquitectura para futuras integraciones con sistemas de hogar inteligente, aunque no sea obligatorio en la versión inicial para todos.|
|Prioriza recomendaciones específicas de acción	|3	|Sí	|Sí	|Sí	|100 %|	Ofrecer en la interfaz sugerencias paso a paso ("añade X ml de agua", "mueve a sombra") basadas en los datos de sensores antes de emitir la alerta.|
...
- Betty habla de “darles vida” y conversa con sus plantas para promover su crecimiento.<br><br>

- Yasser describe la jardinería como un vínculo emocional que le aporta energía y paz.<br><br>

- **Implicaciones:** Incorporar feedback visual atractivo (por ejemplo, pequeñas animaciones o iconos que muestren “alegría” cuando la planta alcanza parámetros óptimos). Entregar mensajes motivadores o felicitaciones que refuercen el lazo afectivo.  Permitir al usuario personalizar nombres o fotos de sus macetas para reforzar la sensación de cuidado personal y apego.

**2. Enfoque observacional y empírico**

- Los tres entrevistados describen métodos caseros (ajo, cáscaras, observación visual constante) como base de su rutina de cuidado.<br><br>

- Hay reticencia a depender únicamente de lecturas automáticas, confían en su intuición y chequeo manual.<br><br>

- **Implicaciones:** Presentar datos de sensores de forma que complementen la observación, no la reemplacen: por ejemplo, incluir consejos cortos (“Observa las hojas: si están caídas, añade un 5 % más de agua”). Ofrecer gráficos superpuestos con fotos para que comparen visualmente el estado actual con el histórico.

**3. Balance entre control manual y automatización**

- Betty desea automatizar riego sin perder la opción de intervenir a voluntad.<br><br>

- Javier y Yasser mencionan explícitamente que el sistema debe permitir alternar entre riego manual y automático.<br><br>

- **Implicaciones:** Ofrecer sliders o controles de ajuste manual en cada ficha de planta (por ejemplo, ajustar porcentaje de riego automático a un punto específico, para que el resto sea manual). Generar una notificación que indique al usuario cuando puede realizar riego manual, puesto que el riego automático es en otro día.

**4. Actitud meticulosa y orientada al detalle**

- Javier y Yasser insisten en la necesidad de datos granulares (porcentaje exacto de humedad, decimales de pH).<br><br>

- Betty valora saber con precisión si está regando demasiado o muy poco.<br><br>

- **Implicaciones:** Mostrar métricas detalladas en cada tarjeta de planta: temperatura con décimas, humedad con porcentaje exacto, salinidad con dS/m y acidez en escala del 0 al 14 con decimales. Ofrecer gráficos de historial (diario, semanal y mensual) que permitan hacer zoom en franjas específicas (por hora o día).

**5. Valoración estético-funcional del producto**

- Todos piden que la maceta sea discreta y minimalista, evitando cables expuestos que rompan la estética.<br><br>

- Javier y Yasser desean que el dispositivo se integre con entornos modernos y de domótica, mientras que Betty lo quiere armonioso con su hogar.<br><br>

- **Implicaciones:** Diseñar la carcasa en cerámica blanca o tonos grises claros, con líneas suaves y superficie mate, para que no desentone en interiores. Ocultar los cables en una base encastrada o mueble lateral, o bien incluir canaletas camufladas para guiarlos de forma ordenada. En la app, emplear una paleta de colores naturales (verde pálido, verde bosque, verde azulado) y tipografía sans-serif legible, reforzando el minimalismo físico con una interfaz igualmente limpia. 

**6. Necesidad de supervisión remota en tiempo real**

- Javier y Yasser requieren notificaciones push inmediatas para tomar decisiones desde cualquier lugar.<br><br>

- Betty prefiere supervisar desde un punto fijo (su hogar), sin necesidad de alertas constantes en el móvil.<br><br>

- **Implicaciones:** Permitir configurar perfiles de notificación: alertas inmediatas y detalladas vía push, o alertas resumidas y revisiones periódicas desde el dashboard. Implementar un dashboard web accesible desde laptop para quienes no dependen del móvil, con refresco automático de datos cada pocos minutos. Incorporar modos de ahorro de notificaciones: por ejemplo, “No molestar” en horas nocturnas o “Resumen diario” para agrupar alertas en un solo reporte.

**7. Motivación por ahorro de recursos y sostenibilidad**

- Betty menciona que desea evitar desperdiciar agua y nutrientes usando datos precisos. <br><br>
  
- Javier destaca que un riego más eficiente le permitiría reducir visitas presenciales y costos operativos. <br><br>
  
- Yasser afirma que “cada litro de agua cuenta” cuando maneja cientos de plantas.<br><br>

- **Implicaciones:** Incluir en la interfaz indicadores de sostenibilidad que muestren litros de agua ahorrados y dosis de nutrientes optimizadas por planta. Ofrecer comparativas gráficas entre métodos manuales y automatizados. Sugerir prácticas ecológicas complementarias (reutilización de agua de lluvia, abonos orgánicos), reforzando el valor ambiental de Macetech.

**8. Uso o interés en domótica**

- Uno de los entrevistados (Yasser) expresa deseo de integración con asistentes de voz de servicios de domótica. Esto con el fin de usar con más rapidez las funciones de la aplicación.<br><br>

- **Implicaciones:** Diseñar arquitectura modular para permitir integración futura. Se puede ofrecer un API o webhook para sincronizar con Alexa/Google Home, sin afectar la experiencia básica de quienes no lo demandan.

**9. Preferencia por interacción visual y sencilla**

- Los tres entrevistados valoran interfaces limpias y directas. Betty solicita “una interfaz extremadamente simple, sin alertas móviles invasivas”. Javier menciona que “la app debe ser intuitiva y no abrumar con tantos menús”. Yasser desea ver datos esenciales en un vistazo rápido, sin demasiados clics.<br><br>

- **Implicaciones:** Diseñar pantallas principales con tarjetas de planta minimalistas que muestren solo los datos críticos (humedad, pH, estado general). Utilizar iconografía clara y colores suaves para indicar estados (p. ej., verde para óptimo, amarillo para atención, rojo para crítico). Evitar menús anidados; en su lugar, usar un sistema de pestañas o swipe para desplazar entre secciones (Riego, Abono, Historial).

**10. Frustración frente a la detección tardía de problemas**

- Javier y Yasser señalan que las variaciones climáticas y la llegada de plagas suelen detectarse “a puro ojo” demasiado tarde. Javier comenta que “si la plaga ya está avanzada, a veces no hay forma de salvar la planta”.<br><br>
...
* **Necesidades Clave:**
  ...
  * Sensores integrados de pH, humedad, temperatura y salinidad. Métricas en tiempo real con calibración y alertas tempranas.<br><br>

  * Dashboards escalables: agrupación y filtrado de macetas, historiales gráficos diarios/semanales, panel de reportes semanales con recomendaciones variadas.<br><br>

  * Interfaz ligera y limpia: tarjetas minimalistas por planta, iconografía para estados críticos (verde/amarillo/rojo), plantillas de notificaciones personalizables (inmediatas, resumidas, no molestar).<br><br>

  * Soporte para prácticas empíricas. Recomendaciones deben tener en cuenta recetas de remedios (ajo, cáscaras), consejos cortos para complementar datos sensoriales con observación visual.<br><br>
...
* **Criterios de Adopción y Disposición a Pagar:**
  ...
  * Confía en marcas consolidadas (Ferticorp, 4Estaciones, Ergo, Just Home) y compra en tiendas reconocidas (Promart, Sodimac, Maestro, viveros).<br><br>

  * Dispuesto a invertir en planes de suscripción que demuestren un claro ROI (Retorno de la Inversión): comparativas de ahorro frente al método manual, respaldo técnico, acceso a módulos avanzados (pH, nutrientes).
...
https://upcedupe-my.sharepoint.com/:v:/g/personal/u202213143_upc_edu_pe/EfBS6rznTt1Iq8ljFgb2rSUB1kgNoQuP9vdVTCuw_NjaCQ?e=G51jjx&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D

<img src="/assets/img/portada/about-the-team.png" alt="Video About The Team">
