...
- ¿Quién es el usuario?
  ...
  El usuario es una persona joven o adulta (18 a 45 años), residente en entornos urbanos, interesada en la jardinería doméstica o comunitaria como pasatiempo o actividad terapéutica. Tiene poco o ningún conocimiento técnico sobre el cuidado de plantas y busca integrar esta práctica en su vida cotidiana. Puede vivir en departamentos o casas con espacios limitados (balcones, ventanas, jardines pequeños), o tener espacio en jardines comunitarios de su zona.

- ¿Qué problemas tiene nuestro producto que resolver?

  El usuario enfrenta dificultades relacionadas a la falta de conocimiento técnico sobre las áreas de la jardinería, lo que provoca problemas como el riego ineficiente, la exposición solar inadecuada, y la falta de monitoreo del estado del sustrato. Estas barreras generan frustración, pérdida de motivación y eventual abandono de la actividad. Además, los usuarios sienten que carecen de apoyo profesional o tecnológico que los guíe en el proceso.

- ¿Qué características son importantes?

  El producto debe ser fácil de usar, autónomo, visualmente atractivo y no invasivo. Debe incluir sensores que proporcionen datos confiables en tiempo real (humedad del sustrato, nivel de luz, temperatura y salinidad) y ofrecer recomendaciones simples pero efectivas junto a gráficos de progreso concisos y fáciles de entender. También es crucial que la interfaz sea amigable, con notificaciones claras y un sistema de alertas ante problemas detectados, tanto para la aplicación web como la aplicación móvil.

- ¿Dónde encaja nuestro producto en su trabajo o vida?

  Macetech se integra como una herramienta de apoyo diario o semanal en la rutina del usuario. Su uso se da principalmente en el hogar o la oficina, especialmente en momentos de relajación, fines de semana o al cuidar plantas durante el día. Ayuda a crear un hábito saludable y sostenible, sirviendo tanto para el embellecimiento del entorno como para mejorar la salud mental de los usuarios.

- ¿Cuándo y cómo es nuestro producto usado?

  El producto se usa de forma pasiva y activa. De forma pasiva, los sensores recopilan datos constantemente y alertan al usuario cuando se necesita actuar. De forma activa, el usuario consulta la app móvil para ver el estado de sus plantas, recibir sugerencias o revisar el historial de condiciones. Asimismo, de forma activa, el sistema aplica las funciones de riego automatico. Generalmente, la aplicación móvil o web se usa por breves periodos durante el día (10-20 minutos), cuando el usuario tiene tiempo libre o recibe una notificación.

- ¿Cómo debe verse nuestro producto y cómo comportarse?

  El dispositivo debe tener un diseño moderno, compacto y armonioso con el entorno del hogar. La app debe tener una interfaz limpia, intuitiva y visualmente atractiva, con gráficos claros, íconos reconocibles y colores que indiquen el estado de la planta. El comportamiento del sistema debe ser proactivo, personalizado y educativo, ayudando al usuario a aprender de forma autónoma y mejorar sin sentirse sobrecargado.
...
- ¿Qué otras suposiciones tenemos? ¿Eso, si se prueba que es falso, causará que nuestro proyecto no funcione?
...
1. Proyectamos que aproximadamente el 8 % de los hogares de Lima Metropolitana adoptarán Macetech en sus primeros 12 meses, focalizándonos en jóvenes profesionales (18–45 años) con interés en la sostenibilidad urbana. Para garantizar que vamos por buen camino, revisaremos un hito intermedio de 4 % a los 6 meses. Mediremos nuestro progreso mediante ventas físicas registradas a través de herramientas de análisis como Google Analytics. Esta meta es viable dado el dinamismo del ecosistema IoT: el mercado global de “smart home” alcanzó 155 000 M USD en 2023 y se proyecta en 231 600 M USD para 2028 (Tasa de Crecimiento Anual Compuesto de +7 %) con 785 millones de hogares conectados; regionalmente, el 94 % de los hogares en México y el 90 % en Chile ya usan al menos un dispositivo inteligente, lo que demuestra una alta disposición de los consumidores latinoamericanos a integrar soluciones IoT en el hogar (Thormundsson, 2024; Statista Research Department, 2025). Este primer outcome reviste una importancia estratégica, ya que facilita una evaluación ágil y sistemática de la visibilidad de Macetech, así como del nivel de demanda que presenta en el ecosistema del mercado tecnológico.
  
2. Buscamos reducir la tasa de abandono de usuarios nuevos (churn) a un 20% o menos en los primeros 3 meses, con un hito intermedio de 25 % al alcanzar los primeros 2 meses. Utilizaremos herramientas de Diseño de Producto y Experiencia de Usuario para implementar las mejoras necesarias, monitorizando la tasa de cancelación y realizando análisis de segmentos. Esta iniciativa responde a que las soluciones IoT domésticas presentan un churn promedio del 30–35 % en el primer trimestre (National Institute of Standards and Technology, 2024). Para revertir esta tendencia, desplegaremos un *onboarding* guiado paso a paso, complementado con notificaciones personalizadas al perfil del jardinero, y un dashboard visual que muestre métricas de salud vegetal (humedad, nutrientes, salinidad y acidez) y evidencie el progreso. Con estas acciones, alineadas con las mejores prácticas de retención en smart home, esperamos mejorar significativamente la permanencia de los usuarios. Este segundo outcome es de relevancia crítica, ya que permite maximizar la retención temprana de usuarios potencialmente interesados en nuestro producto, asegurando una respuesta oportuna y eficiente en las etapas iniciales del funnel de adquisición.

3. Nos proponemos alcanzar el top 3 de Google para búsquedas como “maceta inteligente” y “jardinería IoT” en Perú, México y Colombia dentro de los primeros 12 meses, con un hito intermedio de top 10 a los 6 meses. Para conseguir este outcome se utilizaran iniciativas de Marketing Digital & SEO, midiendo nuestro progreso a través de herramientas como SEMrush para rankings y el incremento de tráfico orgánico. Este objetivo se sustenta en la alta receptividad de los consumidores latinoamericanos a la tecnología doméstica: el 94 % de hogares en México ya utiliza dispositivos inteligentes (Thormundsson, 2024), mientras que en Colombia más del 80 % de la población urbana está conectada y las conexiones IoT crecen 15 % anual (Statista Research Department, 2025). Estos indicadores demuestran que, si logramos escalar nuestra visibilidad en buscadores, podremos captar la atención de un público predispuesto a integrar soluciones IoT de jardinería inteligente. Este tercer outcome es de alta relevancia, ya que contribuye significativamente a incrementar la visibilidad del producto dentro de los canales estratégicos de difusión, al mismo tiempo que fortalece el interés y la intención de compra por parte de los usuarios. 

4. Nos comprometemos a que 15 % de los usuarios, o menos, abandonen Macetech por motivos relacionados con privacidad y protección de datos en los primeros tres meses. Emplearemos medidas de Soporte y Comunidad para liderar esta iniciativa, midiendo la percepción de confianza mediante encuestas y analizando los tickets de soporte categorizados como “preocupaciones de privacidad”. Esta meta responde a que el 45 % de los usuarios desconfía de que sus dispositivos inteligentes cumplan con normativas de privacidad (Thormundsson, 2024). Para mitigar estos riesgos, implementaremos un consentimiento explícito en la configuración inicial, almacenamiento cifrado de todos los datos, transparencia total sobre el uso y propósito de la información, y políticas claras de acceso y borrado de datos. Con estas medidas, reforzaremos la legitimidad de Macetech, elevando la confianza del usuario y preservando la retención.

5. Buscamos establecer un Precio Promedio de Venta de 150 USD con un margen bruto alrededor de 35 %. Después de un análisis de costes unitarios por parte del hardware con 90 USD tras economías de escala para sensores, microcontrolador, bomba y ensamblaje (Ibarra-Cabrera et al., 2024); fijamos un precio promedio de venta de 150 USD por maceta individual, garantizando un margen bruto mínimo de 35 %. Con nuestros conocimientos en Finanzas y Operaciones buscaremos validar este precio promedio mediante análisis mensuales, comparando costes reales frente a ingresos. Este posicionamiento está respaldado por la proyección del mercado global de equipos de jardinería inteligente, que crecerá de 7 950 millones USD en 2024 a 17 170 millones USD en 2032 (Tasa de Crecimiento Anual Compuesto de 10.1 %) según Data Bridge Market Research (2025). Un Precio Promedio de Venta en este rango no solo cubre la fabricación, desarrollo de software y soporte, sino que también corresponde al valor percibido por consumidores dispuestos a invertir en soluciones integrales IoT para el cuidado de sus plantas.
