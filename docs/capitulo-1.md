...
1. Proyectamos que aproximadamente el 8% de los hogares de Lima Metropolitana adoptarán Macetech en sus primeros doce meses en el mercado, concentrando los esfuerzos de penetración en jóvenes profesionales de entre 18 y 45 años, con interés por la sostenibilidad urbana. Esta meta es técnicamente viable si consideramos la madurez del ecosistema IoT global. El mercado internacional de soluciones smart home generó 155 000 millones USD en 2023 y se proyecta que alcance 231 600 millones USD en 2028, impulsado por una tasa de crecimiento anual compuesta (CAGR) del 7 % (Thormundsson, 2024). A nivel regional, el 94 % de los hogares en México y el 90 % en Chile ya utilizan al menos un dispositivo inteligente, lo que posiciona a América Latina como una de las regiones con mayor adopción relativa (Thormundsson, 2024; Statista Research Department, 2025). Este comportamiento revela una alta disposición del consumidor a integrar tecnologías IoT en entornos domésticos, lo que representa una oportunidad tangible para introducir soluciones específicas como Macetech, orientadas a la jardinería inteligente y el monitoreo ambiental en entornos urbanos.

2. Buscamos reducir la tasa de abandono de usuarios nuevos en un 20 % o más en los primeros tres meses. Actualmente, las soluciones IoT domésticas registran tasas de pérdida de usuarios del 30–35 % durante el primer trimestre de uso (National Institute of Standards and Technology, 2024). Este abandono se atribuye a procesos de incorporación confusos, falta de acompañamiento y escasa retroalimentación sobre el valor que aporta el dispositivo. Para revertir esta tendencia, implementaremos un modelo de onboarding guiado paso a paso que oriente al usuario desde la configuración inicial hasta la interpretación de datos; notificaciones pedagógicas adaptadas al perfil del jardinero; recordatorios de riego y consejos en el momento justo, y un dashboard visual con métricas de salud vegetal (humedad, nutrientes, luz) que muestre progreso.

3. Proyectamos minimizar el abandono por falta de soporte, apelando al aprendizaje autodidacta y al orgullo de los usuarios. Las investigaciones en jardines comunitarios revelan que hasta el 50 % de los participantes abandona sus espacios en los primeros meses por la ausencia de asesoría técnica (Beavers et al., 2024). Sin embargo, quienes permanecen desarrollan competencias de forma autónoma y experimentan un fuerte sentido de logro, factores clave para la continuidad. Macetech incorporará guías interactivas, ayuda contextual en la app y gráficos de progreso de cuidado. Este enfoque educativo e interactivo fomentará la perseverancia y reducirá la deserción vinculada a la falta de conocimiento (Bieri et al., 2024).

4. Aspiramos en garantizar el cumplimiento normativo con el Reglamento General de Protección de Datos para reforzar la confianza y reducir la deserción por preocupaciones de privacidad. La gestión de datos personales y ambientales mediante sensores IoT implica un riesgo de desconfianza si no se aborda con rigor. Según Thormundsoon (2024), un 45% de los usuarios se preocupa de que sus dispositivos inteligentes no apliquen las normas de privacidad adecuadas. La percepción de seguridad y legitimidad puede impactar directamente en la retención, ante lo cual implementaremos consentimiento explícito, almacenamiento cifrado de datos, transparencia total en el uso y propósito de la información, y políticas claras de privacidad y acceso a borrado de datos.

5. Aspiramos a posicionar a Macetech entre los tres primeros resultados de Google para búsquedas sobre jardinería IoT en Perú, México y Colombia dentro del primer año, aprovechando la alta madurez tecnológica y la creciente adopción del IoT en estos mercados. En México, donde el 94 % de los hogares ya emplea dispositivos inteligentes (Thormundsson, 2024), existe una clara predisposición a integrar tecnologías especializadas; en Colombia, con más del 80 % de la población urbana y un crecimiento anual del 15 % en conexiones IoT (Statista Research Department, 2025), se vislumbra un mercado doméstico emergente de rápido desarrollo; y en Perú, nuestras similitudes demográficas y hábitos de consumo digital facilitan la implementación de campañas y contenidos en español. Además, el mercado global de mobiliario exterior facturó 147 300 M USD en 2024 y se proyecta en 393 000 M USD para 2028, impulsado por la demanda de soluciones sostenibles (Statista Research Department, 2025). Este contexto de crecimiento y receptividad hacia productos inteligentes para el hogar confirma que Macetech puede consolidarse como líder en jardinería inteligente en Latinoamérica.
